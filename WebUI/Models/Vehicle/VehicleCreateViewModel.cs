...
public class VehicleCreateViewModel
{
    ...
    [Display(Name = "Bağlanma Ek Bilgi")]
    ...
    [Required(ErrorMessage = "Bağlayan Ekip bölgesi seçimi gereklidir.")]
    [Display(Name = "Bağlayan Bölge")]
