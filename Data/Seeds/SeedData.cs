...
namespace Data.Seeds
{
    public class SeedData
    {
        ...
        private async Task SeedUsersAsync()
        {
            ...
            if (adminRole == null || userRole == null || operatorRole == null)
            {
                throw new Exception("Roller bulunamadı. Lütfen önce rolleri ekleyin.");
            }
            ...
            var users = new List<User>
            {
                ...
                new User
                {
                    ...
                    UserRoles = new List<UserRole> { new UserRole { RoleId = operatorRole.Id } }
                }
            };
